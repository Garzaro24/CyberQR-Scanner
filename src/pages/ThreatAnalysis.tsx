    ...
    <div className="max-w-7xl mx-auto w-full px-4 md:px-0">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 md:mb-12 gap-6">
        ...
        <div className="flex flex-wrap gap-3 w-full md:w-auto">
          <button className="flex-1 md:flex-none px-4 md:px-6 py-2.5 md:py-3 border border-outline-variant text-on-surface-variant font-semibold rounded-md hover:bg-surface-container-low transition-all text-sm">Notify Admin</button>
          <button className={cn(
